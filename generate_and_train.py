...
MASJIDS = [
    ...
    # 34 New Masjids (Real Lahore Locations)
    {'id': 17, 'name': 'Jamia Masjid Bilal (DHA Phase 3)', 'lat': 31.4852, 'lon': 74.3725, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 18, 'name': 'Jamia Masjid Rehmat (Model Town)', 'lat': 31.4815, 'lon': 74.3280, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 19, 'name': 'Jamia Masjid Al-Shafi (Johar Town)', 'lat': 31.4682, 'lon': 74.2750, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 20, 'name': 'Masjid Al-Fatah (Gulberg)', 'lat': 31.5125, 'lon': 74.3510, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45'}},
    {'id': 21, 'name': 'Jamia Masjid Aqsa (Faisal Town)', 'lat': 31.4780, 'lon': 74.3060, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 22, 'name': 'Masjid Al-Khair (Wapda Town)', 'lat': 31.4310, 'lon': 74.2580, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 23, 'name': 'Jamia Masjid Siddique (Samanabad)', 'lat': 31.5360, 'lon': 74.3120, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 24, 'name': 'Masjid Al-Madina (Garden Town)', 'lat': 31.5010, 'lon': 74.3250, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 25, 'name': 'Jamia Masjid Anwar-e-Madina (Green Town)', 'lat': 31.4420, 'lon': 74.3110, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 26, 'name': 'Masjid Al-Quds (Gulshan-e-Ravi)', 'lat': 31.5490, 'lon': 74.2980, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 27, 'name': 'Jamia Masjid Farooq-e-Azam (Township)', 'lat': 31.4550, 'lon': 74.3080, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 28, 'name': 'Jamia Masjid Hanfia (Sabzazar)', 'lat': 31.5280, 'lon': 74.2880, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 29, 'name': 'Masjid Ibrahim (Bahria Town)', 'lat': 31.3720, 'lon': 74.1880, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45', 'jumuah_fixed': '14:00'}},
    {'id': 30, 'name': 'Jamia Masjid Khalid Bin Walid (Cavalry Ground)', 'lat': 31.5030, 'lon': 74.3760, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 31, 'name': 'Jamia Masjid Usman (Garhi Shahu)', 'lat': 31.5580, 'lon': 74.3530, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 32, 'name': 'Masjid Bilal (Allama Iqbal Town)', 'lat': 31.5180, 'lon': 74.2950, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 33, 'name': 'Jamia Masjid Imam Abu Hanifa (Tajpura)', 'lat': 31.5720, 'lon': 74.4120, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 34, 'name': 'Jamia Masjid Riaz-ul-Jannah (Mughalpura)', 'lat': 31.5650, 'lon': 74.3850, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 35, 'name': 'Jamia Masjid Taqwa (Nishtar Colony)', 'lat': 31.4150, 'lon': 74.3680, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 36, 'name': 'Jamia Masjid Noor (Shalamar)', 'lat': 31.5810, 'lon': 74.3820, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 37, 'name': 'Jamia Masjid Hazrat Bilal (Chung)', 'lat': 31.4180, 'lon': 74.2050, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 38, 'name': 'Jamia Masjid Quba (Cantt)', 'lat': 31.5220, 'lon': 74.4050, 'offsets': {**DEFAULT_OFFSETS, 'jumuah_fixed': '13:45'}},
    {'id': 39, 'name': 'Jamia Masjid Ghausia (Baghbanpura)', 'lat': 31.5780, 'lon': 74.3720, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 40, 'name': 'Jamia Masjid Rehmania (Ichhra)', 'lat': 31.5290, 'lon': 74.3310, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 41, 'name': 'Jamia Masjid Fatima (Johar Town Phase 2)', 'lat': 31.4580, 'lon': 74.2690, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 42, 'name': 'Jamia Masjid Al-Haram (DHA Phase 6)', 'lat': 31.4720, 'lon': 74.4450, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 43, 'name': 'Jamia Masjid Madni (Model Town Extension)', 'lat': 31.4880, 'lon': 74.3360, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45'}},
    {'id': 44, 'name': 'Jamia Masjid Khizra (Samanabad)', 'lat': 31.5320, 'lon': 74.3080, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 45, 'name': 'Jamia Masjid Toheed (Valencia Town)', 'lat': 31.4020, 'lon': 74.2520, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 46, 'name': 'Jamia Masjid Aqsa (Sanda)', 'lat': 31.5670, 'lon': 74.2920, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 47, 'name': 'Jamia Masjid Mustafa (Shadman)', 'lat': 31.5380, 'lon': 74.3350, 'offsets': {**DEFAULT_OFFSETS}},
    {'id': 48, 'name': 'Jamia Masjid Abu Bakar (DHA Phase 5)', 'lat': 31.4650, 'lon': 74.4150, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45', 'jumuah_fixed': '14:15'}},
    {'id': 49, 'name': 'Badshahi Mosque (Walled City)', 'lat': 31.5882, 'lon': 74.3095, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45', 'jumuah_fixed': '14:00'}},
    {'id': 50, 'name': 'Wazir Khan Mosque (Walled City)', 'lat': 31.5830, 'lon': 74.3233, 'offsets': {**DEFAULT_OFFSETS, 'zuhr_fixed': '13:45', 'jumuah_fixed': '14:00'}},
]
